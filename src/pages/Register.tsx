...
import { Eye, EyeOff } from "lucide-react"; // npm install lucide-react (or use your preferred icon library)
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Join <span className="font-medium text-orange-600">BanglaVoyage</span> and start exploring Bangladesh.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center pt-1">
            ...
            />
            <label htmlFor="agreeToTerms" className="ml-2 block text-xs text-slate-600">
              I agree to the{" "}
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <a href="/login" className="font-semibold text-orange-600 hover:underline">
            Log in
          </a>
        </p>
